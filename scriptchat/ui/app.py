...
class ScriptChatUI:
    ...
    def __init__(self, state: AppState):
        ...
        command_completer = WordCompleter(
            ['/new', '/save', '/load', '/branch', '/rename', '/chats', '/send', '/history', '/export', '/export-all', '/import', '/stream', '/prompt', '/run', '/sleep', '/model', '/temp', '/reason', '/thinking', '/timeout', '/profile', '/log-level', '/files', '/clear', '/file', '/echo', '/note', '/tag', '/untag', '/tags', '/assert', '/assert-not', '/undo', '/retry', '/help', '/keys', '/exit'],
            ignore_case=True,
            sentence=True
        )
